      ...
      <main>
        ...
        <SectionShell id="about" title="About" sprites={sectionSprites.about}>
          <p className="text-slate-300 leading-8 text-lg">
            ...
            I have learned that strong engineering is rarely done in isolation. I am especially interested in
            how large-scale systems behave under practical constraints and how thoughtful design can improve
